# Generated by Django 4.1.3 on 2022-11-30 21:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата полученя заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relatrd_products', to='mainapp.cart', verbose_name='Корзина')),
